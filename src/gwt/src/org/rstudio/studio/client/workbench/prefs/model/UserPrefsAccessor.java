...
public class UserPrefsAccessor extends Prefs
{
   ...
   public static final String RUN_RPROFILE_ON_RESUME = "run_rprofile_on_resume";
   public static final String SAVE_WORKSPACE = "save_workspace";
   public static final String LOAD_WORKSPACE = "load_workspace";
   public static final String INITIAL_WORKING_DIRECTORY = "initial_working_directory";
   public static final String CRAN_MIRROR = "cran_mirror";
   public static final String BIOCONDUCTOR_MIRROR_NAME = "bioconductor_mirror_name";
   public static final String BIOCONDUCTOR_MIRROR_URL = "bioconductor_mirror_url";
   ...
   public static final String POSIX_TERMINAL_SHELL = "posix_terminal_shell";
   public static final String CUSTOM_SHELL_COMMAND = "custom_shell_command";
   public static final String CUSTOM_SHELL_OPTIONS = "custom_shell_options";
   public static final String SHOW_LINE_NUMBERS = "show_line_numbers";
   public static final String RELATIVE_LINE_NUMBERS = "relative_line_numbers";
   public static final String HIGHLIGHT_SELECTED_WORD = "highlight_selected_word";
   public static final String HIGHLIGHT_SELECTED_LINE = "highlight_selected_line";
   public static final String PANES = "panes";
   public static final String ALLOW_SOURCE_COLUMNS = "allow_source_columns";
   public static final String USE_SPACES_FOR_TAB = "use_spaces_for_tab";
   public static final String NUM_SPACES_FOR_TAB = "num_spaces_for_tab";
   public static final String AUTO_DETECT_INDENTATION = "auto_detect_indentation";
   public static final String SHOW_MARGIN = "show_margin";
   public static final String BLINKING_CURSOR = "blinking_cursor";
   public static final String MARGIN_COLUMN = "margin_column";
   public static final String MARGIN_COLUMN_SOFT_WRAP = "margin_column_soft_wrap";
   public static final String MARGIN_COLUMN_EDITOR_WIDTH = "margin_column_editor_width";
   public static final String SHOW_INVISIBLES = "show_invisibles";
   public static final String INDENT_GUIDES = "indent_guides";
   ...
   public static final String TAB_MULTILINE_COMPLETION = "tab_multiline_completion";
   public static final String TAB_COMPLETION = "tab_completion";
   public static final String SHOW_HELP_TOOLTIP_ON_IDLE = "show_help_tooltip_on_idle";
   public static final String SURROUND_SELECTION = "surround_selection";
   public static final String ENABLE_SNIPPETS = "enable_snippets";
   public static final String CODE_COMPLETION = "code_completion";
   public static final String CODE_COMPLETION_OTHER = "code_completion_other";
   public static final String CONSOLE_CODE_COMPLETION = "console_code_completion";
   public static final String CODE_COMPLETION_DELAY = "code_completion_delay";
   public static final String CODE_COMPLETION_CHARACTERS = "code_completion_characters";
   public static final String CODE_COMPLETION_INCLUDE_ALREADY_USED = "code_completion_include_already_used";
   public static final String SHOW_FUNCTION_SIGNATURE_TOOLTIPS = "show_function_signature_tooltips";
   public static final String SHOW_DATA_PREVIEW = "show_data_preview";
   public static final String SHOW_DIAGNOSTICS_R = "show_diagnostics_r";
   public static final String SHOW_DIAGNOSTICS_CPP = "show_diagnostics_cpp";
   public static final String SHOW_DIAGNOSTICS_YAML = "show_diagnostics_yaml";
   public static final String SHOW_DIAGNOSTICS_OTHER = "show_diagnostics_other";
   public static final String STYLE_DIAGNOSTICS = "style_diagnostics";
   public static final String DIAGNOSTICS_ON_SAVE = "diagnostics_on_save";
   public static final String BACKGROUND_DIAGNOSTICS = "background_diagnostics";
   public static final String BACKGROUND_DIAGNOSTICS_DELAY_MS = "background_diagnostics_delay_ms";
   public static final String DIAGNOSTICS_IN_R_FUNCTION_CALLS = "diagnostics_in_r_function_calls";
   public static final String CHECK_ARGUMENTS_TO_R_FUNCTION_CALLS = "check_arguments_to_r_function_calls";
   ...
   public static final String RESTORE_SOURCE_DOCUMENT_CURSOR_POSITION = "restore_source_document_cursor_position";
   public static final String REINDENT_ON_PASTE = "reindent_on_paste";
   public static final String VERTICALLY_ALIGN_ARGUMENTS_INDENT = "vertically_align_arguments_indent";
   public static final String SOFT_WRAP_R_FILES = "soft_wrap_r_files";
   ...
   public static final String RAINBOW_FENCED_DIVS = "rainbow_fenced_divs";
   public static final String CONSOLE_LINE_LENGTH_LIMIT = "console_line_length_limit";
   public static final String CONSOLE_MAX_LINES = "console_max_lines";
   public static final String ANSI_CONSOLE_MODE = "ansi_console_mode";
   public static final String SHOW_INLINE_TOOLBAR_FOR_R_CODE_CHUNKS = "show_inline_toolbar_for_r_code_chunks";
   public static final String HIGHLIGHT_CODE_CHUNKS = "highlight_code_chunks";
   public static final String SAVE_FILES_BEFORE_BUILD = "save_files_before_build";
   public static final String SAVE_AND_RELOAD_WORKSPACE_ON_BUILD = "save_and_reload_workspace_on_build";
   public static final String FONT_SIZE_POINTS = "font_size_points";
   public static final String EDITOR_LINE_HEIGHT = "editor_line_height";
   public static final String HELP_FONT_SIZE_POINTS = "help_font_size_points";
   ...
   public static final String DEFAULT_OPEN_PROJECT_LOCATION = "default_open_project_location";
   public static final String SOURCE_WITH_ECHO = "source_with_echo";
   public static final String DEFAULT_SWEAVE_ENGINE = "default_sweave_engine";
   public static final String DEFAULT_LATEX_PROGRAM = "default_latex_program";
   public static final String USE_ROXYGEN = "use_roxygen";
   public static final String USE_DATAIMPORT = "use_dataimport";
   public static final String PDF_PREVIEWER = "pdf_previewer";
   public static final String ALWAYS_ENABLE_RNW_CONCORDANCE = "always_enable_rnw_concordance";
   public static final String INSERT_NUMBERED_LATEX_SECTIONS = "insert_numbered_latex_sections";
   public static final String SPELLING_DICTIONARY_LANGUAGE = "spelling_dictionary_language";
   public static final String SPELLING_CUSTOM_DICTIONARIES = "spelling_custom_dictionaries";
   public static final String DOCUMENT_LOAD_LINT_DELAY = "document_load_lint_delay";
   public static final String IGNORE_UPPERCASE_WORDS = "ignore_uppercase_words";
   public static final String IGNORE_WORDS_WITH_NUMBERS = "ignore_words_with_numbers";
   public static final String REAL_TIME_SPELLCHECKING = "real_time_spellchecking";
   public static final String NAVIGATE_TO_BUILD_ERROR = "navigate_to_build_error";
   public static final String PACKAGES_PANE_ENABLED = "packages_pane_enabled";
   public static final String PACKAGES_SOURCE_COLUMN_ENABLED = "packages_source_column_enabled";
   public static final String CPP_TEMPLATE = "cpp_template";
   public static final String RESTORE_SOURCE_DOCUMENTS = "restore_source_documents";
   public static final String HANDLE_ERRORS_IN_USER_CODE_ONLY = "handle_errors_in_user_code_only";
   public static final String AUTO_EXPAND_ERROR_TRACEBACKS = "auto_expand_error_tracebacks";
   public static final String CHECK_FOR_UPDATES = "check_for_updates";
   public static final String SHOW_INTERNAL_FUNCTIONS = "show_internal_functions";
   public static final String SHINY_VIEWER_TYPE = "shiny_viewer_type";
   public static final String SHINY_BACKGROUND_JOBS = "shiny_background_jobs";
   public static final String PLUMBER_VIEWER_TYPE = "plumber_viewer_type";
   public static final String DOCUMENT_AUTHOR = "document_author";
   public static final String RMD_AUTO_DATE = "rmd_auto_date";
   public static final String RMD_PREFERRED_TEMPLATE_PATH = "rmd_preferred_template_path";
   public static final String RMD_VIEWER_TYPE = "rmd_viewer_type";
   public static final String SHOW_PUBLISH_DIAGNOSTICS = "show_publish_diagnostics";
   public static final String PUBLISH_CHECK_CERTIFICATES = "publish_check_certificates";
   public static final String USE_PUBLISH_CA_BUNDLE = "use_publish_ca_bundle";
   public static final String PUBLISH_CA_BUNDLE = "publish_ca_bundle";
   public static final String RMD_CHUNK_OUTPUT_INLINE = "rmd_chunk_output_inline";
   ...
   public static final String TERMINAL_LOCAL_ECHO = "terminal_local_echo";
   public static final String TERMINAL_WEBSOCKETS = "terminal_websockets";
   public static final String TERMINAL_CLOSE_BEHAVIOR = "terminal_close_behavior";
   public static final String TERMINAL_TRACK_ENVIRONMENT = "terminal_track_environment";
   public static final String TERMINAL_IGNORED_ENVIRONMENT_VARIABLES = "terminal_ignored_environment_variables";
   public static final String TERMINAL_HOOKS = "terminal_hooks";
   ...
   public static final String LAUNCHER_JOBS_SORT = "launcher_jobs_sort";
   public static final String BUSY_DETECTION = "busy_detection";
   public static final String BUSY_EXCLUSION_LIST = "busy_exclusion_list";
   public static final String KNIT_WORKING_DIR = "knit_working_dir";
   ...
   public static final String CONSOLE_SUSPEND_BLOCKED_NOTICE = "console_suspend_blocked_notice";
   ...
   public static final String VCS_AUTOREFRESH = "vcs_autorefresh";
   public static final String GIT_EXE_PATH = "git_exe_path";
   public static final String SVN_EXE_PATH = "svn_exe_path";
   public static final String TERMINAL_PATH = "terminal_path";
   public static final String RSA_KEY_PATH = "rsa_key_path";
   public static final String SSH_KEY_TYPE = "ssh_key_type";
   public static final String USE_DEVTOOLS = "use_devtools";
   public static final String CLEAN_BEFORE_INSTALL = "clean_before_install";
   public static final String USE_BUILD_SUBDIRECTORY = "use_build_subdirectory";
   public static final String USE_SECURE_DOWNLOAD = "use_secure_download";
   public static final String CLEANUP_AFTER_R_CMD_CHECK = "cleanup_after_r_cmd_check";
   public static final String VIEW_DIR_AFTER_R_CMD_CHECK = "view_dir_after_r_cmd_check";
   public static final String HIDE_OBJECT_FILES = "hide_object_files";
   public static final String RESTORE_LAST_PROJECT = "restore_last_project";
   public static final String PROJECT_SAFE_STARTUP_SECONDS = "project_safe_startup_seconds";
   public static final String USE_TINYTEX = "use_tinytex";
   public static final String CLEAN_TEXI2DVI_OUTPUT = "clean_texi2dvi_output";
   public static final String LATEX_SHELL_ESCAPE = "latex_shell_escape";
   ...
   public static final String TAB_KEY_MOVE_FOCUS = "tab_key_move_focus";
   public static final String FIND_PANEL_LEGACY_TAB_SEQUENCE = "find_panel_legacy_tab_sequence";
   public static final String SHOW_PANEL_FOCUS_RECTANGLE = "show_panel_focus_rectangle";
   ...
   public static final String VISUAL_MARKDOWN_EDITING_LIST_SPACING = "visual_markdown_editing_list_spacing";
   public static final String VISUAL_MARKDOWN_EDITING_WRAP = "visual_markdown_editing_wrap";
   public static final String VISUAL_MARKDOWN_EDITING_WRAP_AT_COLUMN = "visual_markdown_editing_wrap_at_column";
   public static final String VISUAL_MARKDOWN_EDITING_REFERENCES_LOCATION = "visual_markdown_editing_references_location";
   public static final String VISUAL_MARKDOWN_EDITING_CANONICAL = "visual_markdown_editing_canonical";
   public static final String VISUAL_MARKDOWN_EDITING_MAX_CONTENT_WIDTH = "visual_markdown_editing_max_content_width";
   public static final String VISUAL_MARKDOWN_EDITING_SHOW_DOC_OUTLINE = "visual_markdown_editing_show_doc_outline";
   public static final String VISUAL_MARKDOWN_EDITING_SHOW_MARGIN = "visual_markdown_editing_show_margin";
   public static final String VISUAL_MARKDOWN_CODE_EDITOR_LINE_NUMBERS = "visual_markdown_code_editor_line_numbers";
   public static final String VISUAL_MARKDOWN_EDITING_FONT_SIZE_POINTS = "visual_markdown_editing_font_size_points";
   public static final String VISUAL_MARKDOWN_CODE_EDITOR = "visual_markdown_code_editor";
   public static final String ZOTERO_LIBRARIES = "zotero_libraries";
   public static final String EMOJI_SKINTONE = "emoji_skintone";
   public static final String DISABLED_ARIA_LIVE_ANNOUNCEMENTS = "disabled_aria_live_announcements";
   public static final String SCREENREADER_CONSOLE_ANNOUNCE_LIMIT = "screenreader_console_announce_limit";
   public static final String FILE_MONITOR_IGNORED_COMPONENTS = "file_monitor_ignored_components";
   public static final String FILE_MONITOR_USE_GITIGNORE = "file_monitor_use_gitignore";
   public static final String INSTALL_PKG_DEPS_INDIVIDUALLY = "install_pkg_deps_individually";
   public static final String GRAPHICS_BACKEND = "graphics_backend";
   public static final String GRAPHICS_ANTIALIASING = "graphics_antialiasing";
   public static final String BROWSER_FIXED_WIDTH_FONTS = "browser_fixed_width_fonts";
   public static final String PYTHON_TYPE = "python_type";
   ...
   public static final String TERMINAL_PYTHON_INTEGRATION = "terminal_python_integration";
   public static final String SESSION_PROTOCOL_DEBUG = "session_protocol_debug";
   public static final String PYTHON_PROJECT_ENVIRONMENT_AUTOMATIC_ACTIVATE = "python_project_environment_automatic_activate";
   public static final String CHECK_NULL_EXTERNAL_POINTERS = "check_null_external_pointers";
   public static final String UI_LANGUAGE = "ui_language";
   public static final String AUTOHIDE_MENUBAR = "autohide_menubar";
   public static final String NATIVE_FILE_DIALOGS = "native_file_dialogs";
   public static final String DISCARD_PENDING_CONSOLE_INPUT_ON_ERROR = "discard_pending_console_input_on_error";
   public static final String EDITOR_SCROLL_MULTIPLIER = "editor_scroll_multiplier";
   public static final String TEXT_RENDERING = "text_rendering";
   ...
   public static final String COPILOT_TAB_KEY_BEHAVIOR = "copilot_tab_key_behavior";
   public static final String COPILOT_INDEXING_ENABLED = "copilot_indexing_enabled";
   public static final String COPILOT_NES_ENABLED = "copilot_nes_enabled";
   public static final String COPILOT_NES_AUTOSHOW = "copilot_nes_autoshow";
   public static final String COPILOT_SHOW_MESSAGES = "copilot_show_messages";
   public static final String COPILOT_PROJECT_WORKSPACE = "copilot_project_workspace";
   public static final String PROJECT_NAME = "project_name";
   public static final String RUN_BACKGROUND_JOB_DEFAULT_WORKING_DIR = "run_background_job_default_working_dir";
   public static final String CODE_FORMATTER = "code_formatter";
